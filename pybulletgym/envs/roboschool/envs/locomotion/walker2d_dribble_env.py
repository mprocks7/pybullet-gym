...
from pybulletgym.envs.roboschool.robots.locomotors.walker_dribble import WalkerDribble
import numpy as np
# from pybulletgym.envs.roboschool.robots.locomotors import Walker2D


class Walker2DDribbleBulletEnv(WalkerBaseBulletEnv):
    def __init__(self):
        self.robot = WalkerDribble()
        # self.robot = Walker2D()
        WalkerBaseBulletEnv.__init__(self, self.robot)
        self.ball_previous_pos_x = 1
