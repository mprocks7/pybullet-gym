...
class HumanoidFlagrun(Humanoid):
    ...
    def flag_reposition(self):
        ...
        if self.flag:
            self._p.resetBasePositionAndOrientation(self.flag.bodies[0], [self.walk_target_x, self.walk_target_y, 0.5], [0, 0, 0, 1])
        else:
            self.flag = ObjectHelper.get_ball(self._p, self.walk_target_x, self.walk_target_y, 0.5)
        ...
        self.flag_timeout = 99900/self.scene.frame_skip  # match Roboschool
